...
export function OrgForm() {
  ...
  const set = (k: keyof typeof form, mask?: (v: string) => string) => (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <form onSubmit={(e) => { e.preventDefault(); onSave() }} className="space-y-6">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <Input id="cnpj" value={form.cnpj} onChange={set('cnpj', maskCNPJ)} placeholder="00.000.000/0000-00" />
        </div>
        <div className="grid gap-2">
          <Label htmlFor="phone">Telefone</Label>
          <Input id="phone" value={form.phone} onChange={set('phone', maskPhoneBR)} placeholder="(11) 99999-9999" />
        </div>
        <div className="grid gap-2 sm:col-span-2">
        ...
        <div className="grid gap-2">
          ...
          <Input id="postal" value={form.postalCode} onChange={set('postalCode', maskCEP)} />
        </div>
        <div className="grid gap-2">
