...
import type { ClientHealthMetrics } from '@/features/clients/components'
    ...
    <div className="relative min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-slate-100 dark:from-slate-950 dark:via-blue-950/20 dark:to-slate-900">
      ...
      <div className="relative space-y-6 p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button className="gap-2 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-0 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200">
            <Download className="h-4 w-4" />
            Exportar PDF
          </Button>
        </div>

        {/* Health Card - Novo componente reutilizável */}
