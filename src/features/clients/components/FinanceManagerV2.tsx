    ...
    <>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card className="relative overflow-hidden border-2 border-red-200/60 shadow-xl shadow-red-200/50">
          ...
          <Card
            className={`relative overflow-hidden border-2 shadow-xl ${totals.balance >= 0
